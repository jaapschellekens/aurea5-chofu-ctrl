...
Gebruik:
    ...
    python wp_simulator.py --host 192.168.1.8 --prefix chofu_test --modus ff_water  # testbord

Topics gebruiken --prefix (default "chofu"). Zet dit gelijk aan MQTT_PREFIX in
types.h zodat je een testbord aanstuurt zonder het productiesysteem te raken.
"""
import argparse
import math
import time
